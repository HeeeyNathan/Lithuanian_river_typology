...
INPUT_ENV_FILE        <- "Output data/2_annual_environmental_means_2009-2023.xlsx"

FULL_GRID_OUT_FILE    <- "Output data/Elevation_DEM_grid_Lithuania_300x300_full.csv"
CLIPPED_GRID_OUT_FILE <- "Output data/Elevation_DEM_grid_Lithuania_300x300_clipped.csv"
...
ggsave(
  filename = file.path(PLOTS_DIR, "DEM_Elevation_300x300_Grid.png"),
  plot     = p_full,
  width    = 10,
  height   = 9,
  dpi      = 450,
...
ggsave(
  filename = file.path(PLOTS_DIR, "DEM_Elevation_300x300_Grid_Clipped_Lithuania.png"),
  plot     = p_clip,
  width    = 10,
  height   = 9,
  dpi      = 450,
